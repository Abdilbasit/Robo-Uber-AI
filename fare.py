...
class Fare:
      ...
      def dropOff(self):
          ...
          Fare.overallIncome += self.price
           
          if (self.taxi.number == 100):
              Fare.accountZero  += self.price
          elif(self.taxi.number == 101):
              Fare.accountOne  += self.price
          elif(self.taxi.number == 102):
              Fare.accountTwo  += self.price
          elif(self.taxi.number == 103):
              Fare.accountThree  += self.price
